INSERT INTO users (account_non_expired, account_non_locked, credentials_non_expired, enabled, reset_password_token, reset_password_token_expiry, id, created_at, email, password, user_status, updated_at, user_score, username, role, display_name) VALUES
(true, true, true, true, null, null, 1, '2025-01-02 10:30:00', 'ev@mail.ru', '$2a$12$dEsTt99U7y8Lfjn8UpwZRu9vyG5mGE7HnxGTy2QSWURGGtg6PJMBi', 'ACTIVE', '2025-01-03 10:30:00', 0, 'Evgeny', 'USER', 'Evgeny'),
(true, true, true, true, null, null,2, '2025-01-03 10:30:00', 'AQ@mail.ru', '$2a$12$dEsTt99U7y8Lfjn8UpwZRu9vyG5mGE7HnxGTy2QSWURGGtg6PJMBi', 'ACTIVE', '2025-01-04 10:30:00', 0, 'Alex', 'ADMIN', 'Alex'),
(true, true, true, true, null, null,3, '2025-01-01 10:30:00', 'qqqq@mail.ru', '$2a$12$dEsTt99U7y8Lfjn8UpwZRu9vyG5mGE7HnxGTy2QSWURGGtg6PJMBi', 'ACTIVE', '2025-01-04 10:30:00', 0, 'GLoria', 'USER', 'GLoria'),
(true, true, true, true, null, null,4, '2024-12-29 10:30:00', 'c1_c1@mail.ru', '$2a$12$dEsTt99U7y8Lfjn8UpwZRu9vyG5mGE7HnxGTy2QSWURGGtg6PJMBi', 'ACTIVE', '2025-01-01 10:30:00', 0, 'Timur', 'USER', 'Timur'),
(true, true, true, true, null, null,5, '2024-12-30 10:30:00', 'well_9@mail.ru', '$2a$12$dEsTt99U7y8Lfjn8UpwZRu9vyG5mGE7HnxGTy2QSWURGGtg6PJMBi', 'ACTIVE', '2025-01-02 10:30:00', 0, 'Sarah', 'USER', 'Sarah');
